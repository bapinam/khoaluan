...
namespace KhoaLuan.Data.Migrations
{
    ...
    [Migration("20210525152320_Date1")]
    partial class Date1
    {
            ...
            modelBuilder.Entity("KhoaLuan.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "a67dffe7-cbd5-4b0c-8985-b3215e9868c5",
            ...
            modelBuilder.Entity("KhoaLuan.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Card = "0123456789",
                            Code = "Admin",
                            ConcurrencyStamp = "0bb8def6-f758-487d-85d6-9f36b2c1c3a7",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAECrFFKU1BaA20OkXYwaVsmtnpIThNUIOpiINdzWVt8nSCMrLg5Heka0EBqEY+XZVeA==",
            ...
            modelBuilder.Entity("KhoaLuan.Data.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 25, 22, 23, 17, 912, DateTimeKind.Local).AddTicks(8276));
                    ...
                    b.Property<DateTime>("PurchaseDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 25, 22, 23, 17, 915, DateTimeKind.Local).AddTicks(256));
            ...
            modelBuilder.Entity("KhoaLuan.Data.Entities.Material", b =>
                {
                    ...
                    b.Property<DateTime>("ReminderEndDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 25, 22, 23, 17, 978, DateTimeKind.Local).AddTicks(4535));

                    b.Property<DateTime>("ReminderStartDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 25, 22, 23, 17, 978, DateTimeKind.Local).AddTicks(3969));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Bột gạo",
                            Reminder = false,
                            ReminderEndDate = new DateTime(2021, 5, 25, 22, 23, 18, 64, DateTimeKind.Local).AddTicks(1701),
                            ReminderStartDate = new DateTime(2021, 5, 25, 22, 23, 18, 64, DateTimeKind.Local).AddTicks(943)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Name = "Cam",
                            Reminder = false,
                            ReminderEndDate = new DateTime(2021, 5, 25, 22, 23, 18, 64, DateTimeKind.Local).AddTicks(3162),
                            ReminderStartDate = new DateTime(2021, 5, 25, 22, 23, 18, 64, DateTimeKind.Local).AddTicks(3155)
                        });
                });
            ...
            modelBuilder.Entity("KhoaLuan.Data.Entities.Notification", b =>
                {
                    ...
                    b.Property<DateTime>("Time")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 25, 22, 23, 17, 999, DateTimeKind.Local).AddTicks(6697));
            ...
            modelBuilder.Entity("KhoaLuan.Data.Entities.OrderPlan", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 25, 22, 23, 17, 948, DateTimeKind.Local).AddTicks(3115));

                    b.Property<DateTime>("ExpectedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 25, 22, 23, 17, 948, DateTimeKind.Local).AddTicks(4248));
            ...
            modelBuilder.Entity("KhoaLuan.Data.Entities.ProcessPlan", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 25, 22, 23, 17, 926, DateTimeKind.Local).AddTicks(8081));

                    b.Property<DateTime>("ExpectedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 25, 22, 23, 17, 926, DateTimeKind.Local).AddTicks(8611));
            ...
            modelBuilder.Entity("KhoaLuan.Data.Entities.ProcessingVoucher", b =>
                {
                    ...
                    b.Property<DateTime>("CompleteDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 25, 22, 23, 18, 5, DateTimeKind.Local).AddTicks(3953));

                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 25, 22, 23, 18, 5, DateTimeKind.Local).AddTicks(2666));
            ...
            modelBuilder.Entity("KhoaLuan.Data.Entities.Product", b =>
                {
                    ...
                    b.Property<DateTime>("ReminderEndDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 25, 22, 23, 17, 991, DateTimeKind.Local).AddTicks(1852));

                    b.Property<DateTime>("ReminderStartDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 25, 22, 23, 17, 991, DateTimeKind.Local).AddTicks(1338));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Bánh Cam",
                            Reminder = false,
                            ReminderEndDate = new DateTime(2021, 5, 25, 22, 23, 18, 65, DateTimeKind.Local).AddTicks(7161),
                            ReminderStartDate = new DateTime(2021, 5, 25, 22, 23, 18, 65, DateTimeKind.Local).AddTicks(6433)
                        });
                });
